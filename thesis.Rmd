...
Many individual studies and meta-analyses [e.g., @binder2009; @jackson2021; @rodd2015] have shown that these "semantic contrasts" reliably engage a relatively circumscribed, left-lateralized set of cortical regions, consisting of the inferior parietal lobe (especially the angular gyrus), lateral temporal cortex (especially the middle and inferior temporal gyrus), the ventral temporal cortex (fusiform and parahippocampal gyri), the dorso-medial prefrontal cortex, and the inferior frontal gyrus (especially the *pars orbitalis*).
...
More recently, studies have emerged that tried to track semantic processing under more naturalistic circumstances, e.g., by scanning participants while viewing movies or listening to audio books or radio programmes.
