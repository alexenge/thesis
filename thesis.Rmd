...
* Common processing principles in VWFA and LOC/IT?

* Visual shapes in reading are incindental, visual shapes in objects are diagnostic

* Reading is evolutionarily young; must reuse principles from visual object recognition

* Reading requires (at least initially) access to phonology, object vision not

* Top down semantic effects on reading during visual perception?

## Implications for future research

Each of the present studies as well as their intersections provides ample room for additional research.

* Natural reading in children to map semantic space and its shift over time (Deniz et al.)

## Implications for real world applications

* Let's be honest, there are none

## Need for better methods, questions, and theories

* High temporal resolution, spatial resolution, *and* coverage

* Nature/mechanisms of top-down effects completely unclear

* Theories of semantic cognition from linguistics not readily applicable to vision research (?)

* Genereal lack of theory (van Rooij; Meehl) and integration of research findings ("chaos in the brickyard")

* Low replicability in psych and cog neuro

* Need for more explicit assumptions, measurement issues (Scheel)

* Lack of generalizability (Yarkoni)

## Conclusion

* Hope to contribute some insights and stimulate further research

* Methods are re-applicable in different projects (code for meta-analysis, esp. robustness checks, whole-brain LMMs, pipeline)

* Some anecdote about importance of findings (reading, visual objects)?
...
Thank you to Gesa Hartwigsen, Sebastian Markett, Rasha Abdel Rahman, XXX, and XXX for dedicating their time and energy to serve on my dissertation committee and to Gesa Hartwigsen, Rasha Abdel Rahman, and XXX for providing reviews on the written thesis.

But most of all, thank you to my truely wonderful family and friends, especially to my parents and to Gabriele, Julia, Konstantin, Lisa, and Nele.
