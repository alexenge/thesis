...
Wie schafft es unser Gehirn zu verstehen, was unsere Augen sehen?
Wir nehmen unsere Umwelt nicht nur als einen Mix aus Formen und Farben war, sondern sehe unterschiedliche Objekte mit bestimmten Namen und Funktionen.
Wir können schwarze Linien in einer bestimmten Anordnung, auf Papier gedruckt oder auf einen Bildschirm angezeigt, benutzen, um Informationen über Zeit und Raum hinweg zu übertragen, wie zum Beispiel diese Worte, die Sie gerade lesen.
...
Ich gebe einen Überblick über das visuelle und semantische System im menschlichen Gehirn bei Erwachsenen und stelle eine Meta-Analyse von Studien vor, welche mittels funktioneller Magnetresonanztomographie (fMRT) die Hirnaktivität bei semantischer Verarbeitung bei Kindern gemessen hat.
...
Neben den Ergebnissen beschreibe ich die Methoden, welche für die hier beschriebenen Studien neu entwickelt wurden, in der Hoffnung, dass diese auch in zukünftigen Projekten benutzt werden können.
...
How does our brain make sense if what we see?
We perceive the visual world around us not just as a mix of shape and colors but as discrete objects that have names and functions.
...
I then present two experimental studies as examples of learning visual-semantic information.
