...
We hope that this analysis approach and our code (available at <https://github.com/SkeideLab/SLANG-analysis/blob/main/univariate.py>) can be reused for future longitudinal fMRI studies or other studies with complex data acquisition schedules that would benefit from the flexibility provided by linear mixed-effects models.
