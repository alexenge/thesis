...
Eu adipisicing est aute adipisicing exercitation est minim veniam proident laborum veniam. In ullamco commodo eiusmod excepteur sint sunt aliquip consequat cupidatat mollit et. Quis duis excepteur ad duis laboris eiusmod dolore ullamco labore adipisicing. Consequat sint consectetur sit nostrud velit officia eu voluptate. Ex sit enim cillum nisi excepteur fugiat do. Quis occaecat eiusmod nostrud cupidatat sunt excepteur in sunt duis nostrud eu ea ipsum nisi. Id nostrud duis eiusmod proident reprehenderit Lorem tempor laboris sit exercitation et dolor veniam labore.

Non velit exercitation occaecat eiusmod officia est ex excepteur aliquip. Deserunt est irure eiusmod aliqua et occaecat eu fugiat. Id incididunt culpa voluptate voluptate eiusmod officia amet occaecat consectetur nisi est minim labore. Laborum ullamco elit eiusmod commodo quis aute nulla id non. Nisi amet veniam incididunt esse anim labore eu est non laborum exercitation occaecat exercitation. Aute sit ipsum anim qui quis non dolor esse Lorem sunt dolore.

Nulla ipsum proident Lorem culpa ut tempor. Exercitation consequat incididunt quis dolor duis commodo et id. Exercitation eiusmod in laborum et reprehenderit deserunt sunt aliquip exercitation laboris aliquip. Fugiat irure aliqua labore nisi labore eu laboris. Et enim mollit eiusmod officia dolore ut aute sunt excepteur id aute anim elit proident.
...
Many internal operations of *fMRIPrep* use *Nilearn* 0.10.4 [@nilearn, RRID:SCR_001362], mostly within the functional processing workflow.
...
Separately for each participant and session, we modeled the preprocessed BOLD fMRI time series data using a mass-univariate general linear model (GLM) implemented in Nilearn [Version 0.10.4\; @nilearn] for Python [Version 3.9.19\; @vanrossum2009].
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-noise_univariate.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-pseudo_univariate.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-words_univariate.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-pseudo-minus-noise_univariate.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-words-minus-noise_univariate.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-words-minus-pseudo_univariate.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-noise_similarity.png}
\caption{\label{fig:similarity-noise}\textbf{\emph{Audio-visual pattern similarity for low-level controls.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-pseudo_similarity.png}
\caption{\label{fig:similarity-pseudo}\textbf{\emph{Audio-visual pattern similarity for pseudowords.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-words_similarity.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-pseudo-minus-noise_similarity.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-words-minus-noise_similarity.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-words-minus-pseudo_similarity.png}
...
\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-audios-noise_stability.png}
\caption{\label{fig:stability-audios-noise}\textbf{\emph{Pattern stability for spoken low-level contros.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-audios-pseudo_stability.png}
\caption{\label{fig:stability-audios-pseudo}\textbf{\emph{Pattern stability for spoken pseudowords.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-audios-words_stability.png}
\caption{\label{fig:stability-audios-words}\textbf{\emph{Pattern stability for spoken words.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-images-noise_stability.png}
\caption{\label{fig:stability-images-noise}\textbf{\emph{Pattern stability for written low-level contros.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-images-pseudo_stability.png}
\caption{\label{fig:stability-images-pseudo}\textbf{\emph{Pattern stability for written pseudowords.}}}
\end{figure*}

\begin{figure*}
\centering
\includegraphics{figures/task-language_space-MNI152NLin2009cAsym_desc-images-words_stability.png}
